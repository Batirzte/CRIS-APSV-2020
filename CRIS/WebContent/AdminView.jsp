...
<body>
	...
	<h2>Send researcher CV</h2>
	<form action="GenerateCVEmailServlet" method="post">
		<input type="text" name="id" placeholder="Researcher Id"> 
		<button type="submit">Send CV email</button>
	</form>
